            ...
            <form onSubmit={handleAddCategory} className="flex flex-col md:flex-row items-end gap-4">
              ...
              <div className="flex gap-2 justify-end mt-2 md:mt-0">
                <button
                  ...
                  className="px-6 py-3 md:p-3 border border-emerald-100 text-[#5C7562] rounded-xl hover:bg-white transition-all flex items-center justify-center"
                >
                  <HiX size={18} />
                </button>
                <button
                  type="submit"
                  className="px-6 py-3 md:p-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all shadow-md shadow-emerald-900/10 flex items-center justify-center"
                >
                  <HiCheck size={18} />
                </button>
              </div>
