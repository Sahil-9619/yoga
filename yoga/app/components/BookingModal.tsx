...
export const BookingModal = ({
  ...
  const getPrice = () => {
    ...
    if (selectedPriceType === "personal")
      return workshop.personalPrice || workshop.amount || 0;
    if (selectedPriceType === "single")
      return workshop.singleSessionPrice || workshop.amount || 0;
            ...
            <div className="p-6 md:p-8">
              <AnimatePresence mode="wait">
                ...
                {step === "details" && (
                  ...
                  >
                    <div>
                      <h3 className="text-2xl font-serif text-[#1A3320] mb-1">
                        Book Your Spot
                      </h3>
                      <p className="text-[#5C7562] text-xs font-light">
                        Confirm your details to reserve a place.
                      </p>
                    </div>
                      ...
                      <div className="space-y-2 mt-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          {workshop.singleSessionPrice && (
                            ...
                            >
                              ...
                              <span className="text-[10px] opacity-70">
                                ${workshop.singleSessionPrice} USD
                              </span>
                            </button>
                          )}
                          <button
                          ...
                          >
                            <span>Group</span>
                            <span className="text-[10px] opacity-70">
                              ${workshop.groupPrice || workshop.amount} USD
                            </span>
                          </button>
                          <button
                          ...
                          >
                            ...
                            <span className="text-[10px] opacity-70">
                              ${workshop.personalPrice || workshop.amount} USD
                            </span>
                          </button>
                        </div>
                      </div>
                    ...
                    <div className="p-3.5 rounded-xl bg-emerald-50/50 border border-emerald-100 flex gap-3">
                      ...
                      <p className="text-[10px] text-emerald-800/70 leading-relaxed">
                        Your data is encrypted and used only for booking
                        confirmation.
                      </p>
                    </div>
                ...
                {step === "payment" && (
                  ...
                  >
                    <div>
                      <h3 className="text-2xl font-serif text-[#1A3320] mb-1.5">
                        Complete Payment
                      </h3>
                      <p className="text-[#5C7562] text-xs font-light">
                    ...
                    <div className="p-5 rounded-2xl bg-slate-900 text-white space-y-4 relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-start relative z-10">
                        ...
                        <div className="px-2 py-0.5 rounded-full bg-white/10 text-[7px] font-bold uppercase tracking-widest">
                          Secure
                        </div>
                      </div>
                        ...
                        <div className="relative">
                          {isLoading && (
                            <div className="absolute inset-0 bg-white/90 backdrop-blur-[2px] flex flex-col items-center justify-center gap-3 z-50 rounded-2xl py-6">
                              ...
                              <p className="text-xs text-[#5C7562] font-medium">
                            ...
                            onApprove={async (data) => {
                              ...
                              try {
                                ...
                                if (result.status === "COMPLETED") {
                                  ...
                                  setError(
                                    "Payment capture was not completed successfully.",
                                  );
                                  setIsLoading(false);
                                }
                              } catch (e: any) {
                ...
                {step === "success" && (
                  ...
                  >
                    ...
                    <h3 className="text-3xl font-serif text-[#1A3320] mb-2">
                      Confirmed!
                    </h3>
                    <div className="bg-slate-50 rounded-xl p-5 text-left space-y-3 mb-6 mt-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs font-medium text-[#1A3320]">
                            {name}
                          </div>
                        </div>
                      </div>
