    ...
    <main className="bg-[#F8FAF7] min-h-screen pt-32 pb-20 overflow-x-hidden">
      ...
      <section className="px-6 mb-16">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <span className="text-emerald-600 font-bold text-xs tracking-[0.4em] uppercase mb-4 block">
              Get in Touch
            </span>
            <h1 className="text-5xl md:text-7xl font-serif text-[#1A3320] leading-tight mb-6">
              Connect with{" "}
              <span className="text-emerald-700 italic">Sargam.</span>
            </h1>
            <p className="text-[#5C7562] text-lg font-light leading-relaxed max-w-2xl mx-auto">
              Whether you seek spiritual guidance, physical mastery, or
              humanitarian collaboration, I am here to walk the path with you.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
          ...
          >
            ...
            <div className="p-8 md:p-10 flex-1 flex flex-col justify-between">
              <div className="space-y-6">
                <div>
                  <h4 className="text-[#1A3320] font-serif text-lg mb-1">
                    Certified Wellness Coach
                  </h4>
                  <p className="text-[#5C7562] text-sm font-light leading-relaxed">
                    I help conscious entrepreneurs to reclaim their health and
                    vitality
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 group cursor-default">
                    ...
                    <div>
                      <div className="text-[10px] font-bold text-[#1A3320] uppercase tracking-widest">
                        Connect Digitally
                      </div>
                      <div className="text-sm text-[#5C7562]">
              ...
              <div className="mt-10">
                <a
                  ...
                  onClick={(e) => {
                    if (!social.facebook) e.preventDefault();
                  }}
                ...
                >
                  <Button
                    variant="outline"
                    className="w-full py-7 rounded-2xl text-blue-600 border-blue-100 hover:bg-blue-50 hover:border-blue-200 uppercase tracking-[0.2em] text-[10px] font-bold gap-3 group"
                  >
          ...
          >
            <div className="mb-10">
              <h3 className="text-3xl font-serif text-[#1A3320] mb-3">
                Send a Message
              </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-[#5C7562] ml-1">
                    Full Name
                  </label>
                  <input
                    required
